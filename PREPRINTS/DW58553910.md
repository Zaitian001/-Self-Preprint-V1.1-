---
title:  "Groma–Ju Dao: The Six Modes of the *Zhoubi Suanjing* "Ju" as a Geometric Operator System "
...
abstract: |
  ...
  1. *Ping Ju Yi Zheng Sheng* 平矩以正绳 is the initialization of the 3D orthogonal frame $\mathcal{F}_0=(O;\mathbf{e}_x,\mathbf{e}_y,\mathbf{e}_z)$.
  2. *Yan Ju Yi Wang Gao* 偃矩以望高 and *Fu Ju Yi Ce Shen* 覆矩以测深 are the positive and negative directions of the same vertical-angle operator $\pm\theta$.
  3. *Wo Ju Yi Zhi Yuan* 卧矩以知远 is horizontal triangulation.
  4. *Huan Ju Yi Wei Yuan* 环矩以为圆 is the rotation $R_Z(\phi)$ about the $Z$-axis, generating the circle $x^2+y^2=r^2$.
  5. *He Ju Yi Wei Fang* 合矩以为方 is the translation combination $(T_x,T_y)$, generating orthogonal grids.
...
$$ \boxed{ \mathcal{S} = \{ \text{Groma},\ \text{Dioptra},\ \text{Level},\ \text{Plumb},\ \text{Rods} \} } \quad (1) $$
...
1. Set the Groma stand. Align the central plumb line's metal point with the ground station $P_0$:

$$
O\downarrow P_0. \quad (2)
$$

## 2. Level the cross-frame using the level/plumb, ensuring

$$
X,Y\in \Pi_h. \quad (3)
$$

3. The plumb line establishes

$$
Z\parallel \mathbf{g}. \quad (4)
$$

**Geometric Result:**

$$ \boxed{ \mathcal{F}_0 = (O;\ \mathbf{e}_x,\ \mathbf{e}_y,\ \mathbf{e}_z) } \quad (5) $$

with

$$
\mathbf{e}_x\perp \mathbf{e}_y,\qquad
\mathbf{e}_y\perp \mathbf{e}_z,\qquad
\mathbf{e}_z\perp \mathbf{e}_x, \quad (6)
$$
...
1. Groma provides the orthogonal reference $\mathcal{F}_0$ at station $O$, with known horizontal distance $D=OB$ to the tower base.
2. Dioptra is mounted and rotated to elevation angle $+\theta$, sighting the tower top $T$.
3. The sight line $O\to T$ forms angle $\theta$ with the horizontal plane.
...
$$
\tan\theta=\frac{H}{D}, \quad (8)
$$

$$ \boxed{H=D\tan\theta}. \quad (9) $$
...
\boxed{H=\frac{Dh}{d}}. \quad (10)
$$

**Geometric Essence:** This is the frame transformation

$$ \boxed{R_Y(+\theta)\mathcal{F}_0}. \quad (11) $$
...
1. Groma provides the orthogonal reference $\mathcal{F}_0$ at the well edge.
2. Dioptra is rotated to depression angle $-\theta$, sighting the well bottom $B$.
3. The sight line forms angle $|\theta|$ with the horizontal plane.

**Geometric Result:**

Under the idealized level-ground reconstruction:

$$ \boxed{H=D\tan|\theta|}. \quad (12) $$

**Geometric Essence:** This is the frame transformation

$$ \boxed{R_Y(-\theta)\mathcal{F}_0}. \quad (13) $$
...
$$ \boxed{ \text{Yan}=R_Y(+\theta),\qquad \text{Fu}=R_Y(-\theta) }. \quad (14) $$
...
1. Groma provides the orthogonal reference $\mathcal{F}_0$ at station $O$.
2. Establish a baseline $OO'=b$ along one axis:

$$
T_x(b)\mathcal{F}_0. \quad (15)
$$

3. Dioptra measures the horizontal angle $\phi_1=\angle AOB$ to target $A$.
4. A second observation from station $O'$ provides $\phi_2=\angle AO'B$.
5. Triangulation yields the inaccessible distance $AB$.

**Geometric Result:**

Using the law of sines:

$$ \boxed{ AB=\frac{b\cdot \sin\phi_1}{\sin(\phi_1+\phi_2)} }. \quad (16) $$

Or, in the classical similar-triangle form:

$$ \boxed{ AB=b\cdot \frac{d}{c} }. \quad (17) $$

**Geometric Essence:** This is the frame transformation

$$ \boxed{T_x(b)\mathcal{F}_0}, \quad (18) $$
...
1. Groma fixes $O$ and maintains $Z\parallel \mathbf{g}$: $\mathcal{F}_0$.
2. Fix one measuring arm at length $r$ (constant).
3. Rotate the arm about the $Z$-axis:

$$
0\leq \phi<2\pi. \quad (19)
$$

4. The endpoint traces

$$ \mathbf{r}(\phi) = r \begin{pmatrix} \cos\phi\\ \sin\phi\\ 0 \end{pmatrix}. \quad (20) $$

**Geometric Result:**

$$
\boxed{x^2+y^2=r^2}. \quad (21)
$$

**Geometric Essence:** This is the frame transformation

$$ \boxed{R_Z(\phi)\mathcal{F}_0}. \quad (22) $$
...
$$ \boxed{ \text{Ju} \rightarrow \text{Orthogonality} \rightarrow \text{Rotation} \rightarrow \text{Gui} }. \quad (23) $$
...
1. Use Groma to establish the first right angle $X\perp Y$ at origin $O$: $\mathcal{F}_0$.
2. Translate along $X$:

$$
T_x(a)\mathcal{F}_0. \quad (24)
$$

3. Translate along $Y$:

$$
T_y(b)\mathcal{F}_0. \quad (25)
$$

4. Repeat to generate four corners $A,B,C,D$.

**Geometric Result:**

$$
AB\parallel CD,\qquad
AD\parallel BC,\qquad
AB\perp AD, \quad (26)
$$

$$ \boxed{ABCD=\text{square / rectangle}}. \quad (27) $$

**Geometric Essence:** This is the frame composition:

$$ \boxed{T_x(a)T_y(b)\mathcal{F}_0}. \quad (28) $$
...
![Figure 1. The Six Modes of the Ju as Operations on a 3D Orthogonal Frame.]( images/DW58553910/Figure_1.png)
...
$$ \mathcal{F}_0=(O;\ \mathbf{e}_x,\ \mathbf{e}_y,\ \mathbf{e}_z). \quad (29) $$

### 8.2 Level II — Frame Transformation

$$ \boxed{\text{Yan},\quad \text{Fu},\quad \text{Wo},\quad \text{Huan}} $$

$$ \boxed{ R_Y(+\theta),\quad R_Y(-\theta),\quad T_x(b),\quad R_Z(\phi) }. \quad (30) $$

### 8.3 Level III — Frame Composition

$$ \boxed{\text{He}} $$

$$ \boxed{T_x(a)T_y(b)\mathcal{F}_0}. \quad (31) $$

This yields the unifying operator sequence:

$$ \boxed{ \mathcal{F}_0 \xrightarrow{R_Y(+\theta)} \text{Elevation} \xrightarrow{R_Y(-\theta)} \text{Depression} \xrightarrow{T} \text{Projection} \xrightarrow{R_Z(\phi)} \text{Circle} \xrightarrow{T_xT_y} \text{Grid} }. \quad (32) $$
...
| **Fu** 覆 | Invert downward | $R_Y(-\theta)$, $H=D\tan\|\theta\|$ | II: Frame Transformation |
...
$$ \boxed{ \mathcal{J} = \{ \text{Initialize},\ \text{Elevate},\ \text{Depress},\ \text{Project},\ \text{Rotate},\ \text{Compose} \} }. \quad (33) $$
...
![Figure 2. Schematic Reconstruction of the Roman Groma–Ju Discovered in Pompeii; not to scale.]( images/DW58553910/Figure_2.png)
...
1. The Groma is fixed at station $O$, with the plumb line ensuring $Z\parallel \mathbf{g}$.
2. One arm of the cross-frame is fixed at length $r$.
3. The arm is rotated about the $Z$-axis:

$$ 0\leq \phi<2\pi. \quad (34) $$

4. The endpoint traces the circle:

$$ \boxed{x^2+y^2=r^2}. \quad (35) $$
...
$$ \boxed{\text{The Kao Gong Ji records the Groma–Ju system in practice.}} \quad (39) $$

$$ \boxed{\text{The six modes of Shang Gao are the instruction set; the Master Builder's protocol is the execution.}} \quad (40) $$
...
#### 9.6.1 Linear Matrix Transformation of the *Jiujiu Biao* Arithmetic Accelerator in Mode 4
...
$$ \boxed{ x_A=\frac{b\cdot d}{c} }. \quad (41) $$

The *Jiujiu Biao* functions as a discrete look-up table:

$$ \boxed{ \text{Jiujiu Biao}: (b,d)\mapsto b\cdot d \quad\text{then divide by }c }. \quad (42) $$
...
$$ \boxed{ \text{4 external pairs} + \text{1 central self-anchoring point} }. \quad (43) $$
...
$$ \boxed{ \text{自本} \rightarrow \text{臬} \quad (\text{Self} \rightarrow \text{Gnomon}) }. \quad (44) $$
...
$$ \boxed{ \text{身正} \rightarrow \text{臬正} \rightarrow \text{景正} \rightarrow \text{四方正} }. \quad (45) $$
...
$$ \boxed{ \text{身正不怕影子斜——非谓影不斜，谓身正者能读影中之正也。} } \quad (46) $$
...
$$ \boxed{ 1\ (\text{身正/平}) + 4\ \text{dual domains} \times 2\ \text{directions} = 9\ \text{operational degrees of freedom} }. \quad (47) $$
...
1. ***Kao Gong Ji***: "识日出之景与日入之景" (E–W) + "昼参诸日中之景，夜考之极星" (N–S)
2. ***Zhoubi Suanjing***: "晷之两端相直者，正东西也。中折之指表者，正南北也"
3. ***Huainanzi***: Double-gnomon three-point alignment for E–W + midpoint bisection for N–S
4. **Zheng Xuan's commentary on *Zhou Li***: "将以正四方也"
5. ***Yingzao Fashi*** 营造法式: Preserves the complete E–W/N–S two-step structure
...
$$ \boxed{ \text{身正，而后臬正；臬正，而后四方正；四方正，而后天下平。} } \quad (48) $$
...
$$ \boxed{ \text{一平生四对偶，四对偶展八方向，八方向成天下秩序。} } \quad (49) $$
...
$$ \boxed{ \text{The Gui-Ju Dao is a physical instantiation of the "4+1" meta-structure:} } \quad (50) $$ 
$$ \boxed{ \text{one anchor, four projections, eight directions,} \quad \text{and all under Heaven at peace.} } \quad (51) $$
...
![Figure 3. Embodiment of the 3D Orthogonal Coordinate System. Gregor Reisch, *Margarita philosophica*, 1503.](images/DW58553910/Figure_3.png)
...
$$
\mathcal{F}_0=(O;\mathbf{e}_x,\mathbf{e}_y,\mathbf{e}_z). \quad (52)
$$
...
$$ \boxed{ \text{身正 (Body Upright)} \longrightarrow \text{臬正 (Gnomon Upright)} \longrightarrow \text{景正 (Shadow Truthful)} \longrightarrow \text{四方正 (Four Directions True)} }. \quad (53) $$
...
The character 無 (*Wu*) in its archaic form resembles an open vessel—suggesting not emptiness, but a container without a lid. This is not "nothingness"; it is the **prototype of all containing.**

**Translation and decoding:**

| Phrase | Translation | Cosmic Engineering Decoding |
| --- | --- | --- |
| 大要以 Wu 為**有之始終** | In sum, Wu is the beginning and end of all "having" (measure, manifestation, order). | The origin $O$ is the start of every measurement and the point of return (归零/歸元) after every cycle. |
| **Wu器**無間之容也 | Wu is a vessel without gaps, that which contains without interruption. | The origin is not a point of nothingness but a **continuous container** of all potential directions—the **Jade Cong's hollow bore** in philosophical form. |
| 玅 Wu 有之**玄**。鼓吹萬物之**榮**。是為之**紀**。 | The mystery of Wu is the mystery of "having"; it breathes forth the flourishing of all things; this is its **canon/rule** 纪. | The origin is not inert; it is the **generative principle** from which all measurable order unfolds. This is the *Ji* 纪—the universal gauge of cosmic engineering. |
...
1. **The origin $O$ is not a mathematical abstraction**—it is a *Wu Qi*, a continuous vessel that contains all directions and all potential measures.
2. **The act of measurement is the act of manifesting the origin**—making the *Wu Qi* visible through the six operations.
3. **The observer's body is the ultimate *Wu Qi***—the living vessel that contains the three axes, as visually demonstrated in the 1503 woodcut.
4. **Returning to the origin 归零/歸元 is not merely a technical reset**—it is the completion of a cosmic cycle, a re-alignment with the *Yuan*.
...
![Figure 4. The Pictograph *Zhi* 知 as an Embodied Gnomon and Projective Coordinate Frame.](images/DW58553910/Figure_4.png)
...
$$
\text{Observing Eye / Focal Node } E(0,0,h)
$$

$$
\downarrow \quad \text{(Projective Ray)}
$$

$$
\text{Plane } \Pi_c : \text{Circular Spatial Boundary}
$$
...
$$
\text{Ground Plane } \Pi_0 : \text{3D Orthogonal Grid}
$$
...
$$ \boxed{ \mathbf{p} \sim \mathbf{P}_{\text{Zhi}}\mathbf{P} = \begin{pmatrix} f & 0 & 0 & 0\\ 0 & f & 0 & 0\\ 0 & 0 & 1 & 0 \end{pmatrix} \begin{pmatrix} \mathbf{R}_{3\times3} & \mathbf{T}_{3\times1}\\ \mathbf{0}_{1\times3} & 1 \end{pmatrix} \begin{pmatrix} X\\ Y\\ Z\\ 1 \end{pmatrix} }. \quad (55) $$
...
$$ \boxed{ \text{The sixty-four hexagrams = the complete operational state space of the Groma–Ju system.} } \quad (58) $$
...
$$
\mathcal{H}\in\{0,1\}^6\cong\mathbb{Z}_2^6. \quad (59)
$$
...
$$ J_x= \begin{pmatrix} 0 & 0 & 0\\ 0 & 0 & -1\\ 0 & 1 & 0 \end{pmatrix}, \quad J_y= \begin{pmatrix} 0 & 0 & 1\\ 0 & 0 & 0\\ -1 & 0 & 0 \end{pmatrix}, \quad J_z= \begin{pmatrix} 0 & -1 & 0\\ 1 & 0 & 0\\ 0 & 0 & 0 \end{pmatrix}. \quad (60) $$
...
$$ \boxed{ \mathbf{\Omega}_k = \bigotimes_{\ell=1}^{6} \left[ y_\ell \mathbb{I}_{3\times3} + (1-y_\ell) \exp\left( \frac{\pi}{2}J_{\alpha(\ell)} \right) \right] }. \quad (61) $$
...
$$
\alpha(1)=z\ (\text{Ping}),\quad
\alpha(2)=y\ (\text{Yan}),\quad
\alpha(3)=y\ (\text{Fu}),\quad
\alpha(4)=x\ (\text{Wo}),\quad
\alpha(5)=z\ (\text{Huan}),\quad
\alpha(6)=x,y\ (\text{He}). \quad (62)
$$
...
1. *Ping Ju Yi Zheng Sheng* 平矩以正绳 initializes the 3D orthogonal frame

$$
\mathcal{F}_0=(O;\mathbf{e}_x,\mathbf{e}_y,\mathbf{e}_z). \quad (63)
$$

2. *Yan Ju Yi Wang Gao* 偃矩以望高 and *Fu Ju Yi Ce Shen* 覆矩以测深 are the positive and negative directions of the same vertical-angle operator $\pm\theta$.
3. *Wo Ju Yi Zhi Yuan* 卧矩以知远 is horizontal triangulation.
4. *Huan Ju Yi Wei Yuan* 环矩以为圆 is the rotation $R_Z(\phi)$ generating the circle $x^2+y^2=r^2$.
5. *He Ju Yi Wei Fang* 合矩以为方 is the translation combination $(T_x,T_y)$ generating orthogonal grids.
...
$$ \boxed{ \text{玉琮载道，Groma行之，周髀算之，身正歸元。} } \quad (64) $$

$$ \boxed{ \text{The Jade Cong bears the Dao; the Groma performs it; the Zhoubi computes it; the upright body returns to the Yuan.} } \quad (65) $$
